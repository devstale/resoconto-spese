...
<html>
	<head>
		...
		<!-- custom -->
		<script src="<spring:url value="/resources/js/dashboardController.js"/>"></script>
	...
	<body>
			...
			<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-tabs">
					...
					<div class="mdl-layout__header-row">
						...
						<nav class="mdl-navigation mdl-layout--large-screen-only">
							...
							<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" 
								onclick="" style="margin-right: 20px;">Logout
							</button>
						</nav>
					</div>
				</header>
				<div class="mdl-layout__drawer">
					...
					<nav class="mdl-navigation">
						<a class="mdl-navigation__link" onclick="apriModaleConnettiti()">Logout</a>
					</nav>
				</div>
		...
		<dialog class="mdl-dialog" id="modale-connettiti">
			...
			<div class="mdl-dialog__actions">
				<button type="button" class="mdl-button">Connettiti</button>
